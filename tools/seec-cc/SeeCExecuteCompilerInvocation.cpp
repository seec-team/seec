//===- tools/seec-cc/SeeCExecuteCompilerInvocation.cpp --------------------===//
//
//                                    SeeC
//
...
//===----------------------------------------------------------------------===//
///
/// \file This is primarily taken from Clang's
                         ...
                         const char * const *ArgEnd)
{
  ...
  case EmitAssembly:           return llvm::make_unique<SeeCEmitAssemblyAction>
                                                       (ArgBegin, ArgEnd);
  case EmitBC:                 return llvm::make_unique<SeeCEmitBCAction>
                                                       (ArgBegin, ArgEnd);
  case EmitHTML:               return llvm::make_unique<HTMLPrintAction>();
  case EmitLLVM:               return llvm::make_unique<SeeCEmitLLVMAction>
                                                       (ArgBegin, ArgEnd);
  case EmitLLVMOnly:           return llvm::make_unique<SeeCEmitLLVMOnlyAction>
                                                       (ArgBegin, ArgEnd);
  case EmitCodeGenOnly:        return
                               llvm::make_unique<SeeCEmitCodeGenOnlyAction>
                                                (ArgBegin, ArgEnd);
